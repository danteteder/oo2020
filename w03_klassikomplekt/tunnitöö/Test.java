...
class Test {
    public static void main(String[] args) {
        //tunnitööd
        Test test = new Test(); //teeme koopia
        test.name = "My Test name";
        test.length = "30 days";

        Test test2 = new Test();
        test2.name = "My second Test";
        //objektid on eraldi koopiad mida me loome, inimese klassil saame luua inimese omadused ja igale objektile saame 'this'
        // lisada eraldi omadusi või võtta vähemaks etc
